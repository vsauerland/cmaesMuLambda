...
- eigen-3.4.0.tar       // a copy of an EIGEN algebra package version tarball
...
This repos contains a copy of the  EIGEN version 3.4.0 tarball.
The Makefile must be adapted to contain the right path then, i.e., you may want
to change the Makefile line spelling
